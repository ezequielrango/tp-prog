...
//CAMBIE TODO LO QUE DECIA EMAIL O GETEMAIL() POR LA PALABRA SALDO EN LOS ARCHIVOS :  CREATE, USUARIO, HOME.PHP  REPOSITORIO 
...
if (isset($_POST['usuario']) && isset($_POST['clave'])) {
    ...
    $result = $cs->create($_POST['usuario'], $_POST['nombre'], 
                          $_POST['apellido'], $_POST['saldo'], $_POST['clave']);
    if( $result[0] === true ) {
    ...
    <body class="container">
      ...
      <div class="text-center">
        ...
        <form action="create.php" method="post">
            ...
            <input type="text" name="saldo" class="form-control form-control-lg" placeholder="saldo"><br>
